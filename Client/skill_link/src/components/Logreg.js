...
const Logreg = props => {
  ...
  return (
    <>
      ...
      <Modal title="Basic Modal" open={isModalOpen} onCancel={handleCancel} footer={<Button type='primary' onClick={handleForget}>Submit</Button>}>
        <form>
